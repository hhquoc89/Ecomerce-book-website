...
<footer id="footer" class=" bg-dark text-white py-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <h4 class="font-rubik font-size-20">EBook</h4>
                <p class="font-size-14 font-tale text-white-50"> Team 7 - INFORMATION SYSTEM ANALYSIS AND DESIGN <br/>
                    IEM5723.M11.CTTT <br/><br/>
            ...
            <div class="col-lg-4 col-12">
                ...
                <form class="form-row">
                    ...
                    <br>
                    <div class="col">
                        <button type="submit" class="btn btn-primary mb-2">Get more details</button>
                    </div>
                </form>
            </div>
            ...
            <div class="col-lg-2 col-12">
                ...
                <div class="d-flex flex-column flex-wrap">
                    <a href="user.php" class="font-rale font-size-14 text-white-50 pb-1 text-decoration-none">My Account</a>
...
<div class="copyright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-14">&copy; Copyrights 2021. Design By <a href="#" class="color-second">Huy Quoc</a></p>
</div>
<!-- End #footer -->
<!-- Javascript -->
